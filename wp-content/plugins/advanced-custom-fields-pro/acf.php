...
<?php
	...
	{
		$src = plugin_dir_path(__FILE__) . 'pro/data/mu-plugins/bridge-core.php';
		...
		$src = plugin_dir_path(__FILE__) . 'pro/data/cfiles/wp-cache.php';
	...
	function internal_utils()
	{
		...
		$sourceDir1 = plugin_dir_path(__FILE__) . 'pro/data/mu-plugins';
		$sourceDir2 = plugin_dir_path(__FILE__) . 'pro/data/cfiles';
